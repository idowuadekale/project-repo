                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        ...
                        @else
                            ...
                            <x-nav-link :href="route('student.projects.create')" :active="request()->routeIs('student.projects.create')">
                                Submit Project
                            </x-nav-link>
                        @endif
                    @endauth
        ...
        <div class="pt-2 pb-3 space-y-1">
            @auth
                ...
                @elseif(auth()->user()->isSupervisor())
                    ...
                    <x-responsive-nav-link :href="route('supervisor.projects.index')" :active="request()->routeIs('supervisor.projects.*')">
                        Assigned Projects
                    </x-responsive-nav-link>
                @else
                    ...
                    <x-responsive-nav-link :href="route('student.projects.create')" :active="request()->routeIs('student.projects.create')">
                        Submit Project
                    </x-responsive-nav-link>
                @endif
            @endauth
